public class Solution{
  static BinaryTreeNode<Integer> bfsToMapParents(BinaryTreeNode<Integer> root,
    ...
    private static int findMaxDistance(HashMap<BinaryTreeNode<Integer>, 
						BinaryTreeNode<Integer>> mpp, BinaryTreeNode<Integer> target) {
        Queue<BinaryTreeNode<Integer>> q = new LinkedList<>();
        q.offer(target);
    ...
    {
        HashMap<BinaryTreeNode<Integer>, BinaryTreeNode<Integer>> mpp = 
																															new HashMap<>();
